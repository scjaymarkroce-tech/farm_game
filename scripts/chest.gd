...
var corn_harvest_scene = preload("res://scenes/objects/corns/corn_harvest.tscn")
var tomato_harvest_scene = preload("res://scenes/objects/tomatoes/tomato_harvest.tscn")
